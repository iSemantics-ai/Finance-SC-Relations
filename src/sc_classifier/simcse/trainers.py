...
from transformer_model.config.core import SENTEVAL
from transformer_model.SentEval import senteval
import numpy as np
from datetime import datetime
from filelock import FileLock
PATH_TO_DATA = 'transformer_model/SentEval/data'
...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        params = {'task_path': SENTEVAL, 'usepytorch': True, 'kfold': 5}
